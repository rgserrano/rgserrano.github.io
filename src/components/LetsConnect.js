...
const LetsConnect = () => {
  return (
    <div className="bg-indigo-200 w-full flex flex-col items-center text-center text-2xl">
      <div className="max-w-screen-md xl:max-w-screen-lg py-14 mx-12">
        ...
        <div className="grid gap-4 grid-rows-2 grid-cols-2 text-white xl:grid-rows-1 xl:grid-cols-4">
          <a href="mailto:reginadonovan191@gmail.com" className="py-3 hover:bg-indigo-600 bg-indigo-500 flex justify-center items-center rounded-lg shadow-lg">
