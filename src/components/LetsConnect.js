    ...
    <div className="bg-purple-100 w-full flex flex-col items-center text-center text-2xl">
      <div className="max-w-screen-md xl:max-w-screen-lg py-14 mx-12">
        ...
        <div className="grid gap-4 grid-rows-2 grid-cols-2 text-white xl:grid-rows-1 xl:grid-cols-4">
          <a
            href="mailto:rg.serrano.03@gmail.com"
            target="_blank" rel="noreferrer"
            className="transform transition ease-in-out duration-150 py-3 hover:bg-indigo-600 bg-indigo-500 flex justify-center items-center rounded-lg shadow-lg"
          >
            <img src={email} alt="email icon" className="inline w-8 mr-2" />
            Email
          </a>
          <a
            href="https://www.linkedin.com/in/rg-serrano/"
            target="_blank"
            rel="noreferrer"
            className="transform transition ease-in-out duration-150 py-3 hover:bg-indigo-600 bg-indigo-500 flex justify-center items-center rounded-lg shadow-lg "
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="transform transition ease-in-out duration-150 py-3 hover:bg-indigo-600 bg-indigo-500 flex justify-center items-center rounded-lg shadow-lg align-middle"
          >
            <img src={resume} alt="Linkedin icon" className="inline w-10 mr-2" />
            Resume
          </a>
          <a
            href="https://github.com/rgserrano"
            target="_blank"
            rel="noreferrer"
            className="transform transition ease-in-out duration-150 py-3 hover:bg-indigo-600 bg-indigo-500 flex justify-center items-center rounded-lg shadow-lg align-middle"
          >
